...
## Sample scoring
To performe the sample scoring function, the gene expression dataset needs to be ranked first by calling the `rankExpr()` function. Then the ranked data and gene sets are input into the `singscoring()` function which returns a data.frame with scores for each sample.
